<<<<<<< HEAD:st/amazon-mwaa-docker-images/tests/images/airflow/3.2.0/test_healthcheck.py
import os
import sys
import pytest
...
def test_main_invalid_component():
    ...
    with patch('sys.argv', ['healthcheck.py', 'INVALID']), \
        ...
        main()
    assert exc_info.value.code == ExitStatus.INVALID_AIRFLOW_COMPONENT.value
>>>>>>> 72a97b2967a22ec1bd207f3e68db75e52ab1848f:st/amazon-mwaa-docker-images/tests/images/airflow/3.2.1/test_healthcheck.py
