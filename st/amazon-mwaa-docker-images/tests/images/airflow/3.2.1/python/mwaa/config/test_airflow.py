<<<<<<< HEAD:st/amazon-mwaa-docker-images/tests/images/airflow/3.2.0/python/mwaa/config/test_airflow.py
...
def test_get_opinionated_airflow_config_merges(monkeypatch):
    ...
    assert result == {
        ...
        "USAGE": "1",
        "DB": "1",
>>>>>>> 72a97b2967a22ec1bd207f3e68db75e52ab1848f:st/amazon-mwaa-docker-images/tests/images/airflow/3.2.1/python/mwaa/config/test_airflow.py
    }