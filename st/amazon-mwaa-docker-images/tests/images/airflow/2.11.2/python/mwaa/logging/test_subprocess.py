<<<<<<< HEAD:st/amazon-mwaa-docker-images/tests/images/airflow/3.2.0/python/mwaa/logging/test_subprocess.py
import pytest
...
def test_read_subprocess_log_stream_process_warning(mocker, subprocess_instance, mock_process, mock_logger):
    ...
    assert mock_process.poll.call_count == 3
    mock_logger.warning.assert_called_once_with('test output\n')
>>>>>>> 72a97b2967a22ec1bd207f3e68db75e52ab1848f:st/amazon-mwaa-docker-images/tests/images/airflow/2.11.2/python/mwaa/logging/test_subprocess.py
