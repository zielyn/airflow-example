<<<<<<< HEAD:st/amazon-mwaa-docker-images/images/airflow/3.2.0/python/mwaa/utils/user_requirements.py
"""
...
async def install_user_requirements(cmd: str, environ: dict[str, str]):
    ...
    if requirements_file and os.path.isfile(requirements_file):
        ...
        logger.info("No user requirements to install.")
>>>>>>> 72a97b2967a22ec1bd207f3e68db75e52ab1848f:st/amazon-mwaa-docker-images/images/airflow/3.3.1/python/mwaa/utils/user_requirements.py
