<<<<<<< HEAD:st/amazon-mwaa-docker-images/images/airflow/3.2.0/python/mwaa/execute_command.py
"""
...
def execute_command(command: str, env: Dict[str, str], container_start_time: float):
    ...
    match command:
        ...
        case "scheduler" | "webserver" | "worker" | "hybrid":
            _run_airflow_command(command, env)
        case _:
>>>>>>> 72a97b2967a22ec1bd207f3e68db75e52ab1848f:st/amazon-mwaa-docker-images/images/airflow/3.2.1/python/mwaa/execute_command.py
