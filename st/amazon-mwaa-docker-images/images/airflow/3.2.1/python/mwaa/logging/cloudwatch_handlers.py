<<<<<<< HEAD:st/amazon-mwaa-docker-images/images/airflow/3.2.0/python/mwaa/logging/cloudwatch_handlers.py
"""
...
class SubprocessLogHandler(BaseLogHandler):
    ...
    def __init__(
        ...
        _stream_name = "%s_%s_%s.log" % (stream_name_prefix, hostname, epoch)
        self.create_cloudwatch_handler(_stream_name, logs_source)
>>>>>>> 72a97b2967a22ec1bd207f3e68db75e52ab1848f:st/amazon-mwaa-docker-images/images/airflow/3.2.1/python/mwaa/logging/cloudwatch_handlers.py
