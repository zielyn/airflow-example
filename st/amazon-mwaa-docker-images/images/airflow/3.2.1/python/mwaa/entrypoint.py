<<<<<<< HEAD:st/amazon-mwaa-docker-images/images/airflow/3.2.0/python/mwaa/entrypoint.py
"""
...
if __name__ == "__main__":
    ...
    logger.error("This module cannot be imported.")
    sys.exit(1)
>>>>>>> 72a97b2967a22ec1bd207f3e68db75e52ab1848f:st/amazon-mwaa-docker-images/images/airflow/3.2.1/python/mwaa/entrypoint.py
